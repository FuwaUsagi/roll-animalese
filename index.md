<html>
<head>
    <title>animalese.js but its personal</title>
</head>
...
<body>
    <h2>animalese.js but its personal</h2>
    <p>original and source: <a href="https://github.com/Acedio/animalese.js">https://github.com/Acedio/animalese.js</a>.</p>
    <textarea id="text" rows"4" cols="50">Testing out animalese.js. Did it work?</textarea><br/>
    <label><input id="shorten" type="checkbox"/>Shorten</label><br/>
